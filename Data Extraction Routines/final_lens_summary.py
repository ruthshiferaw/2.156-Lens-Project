...
# # ---------------------------
# def find_lens_file(directory, base_prefix):
#     """
#     Attempt to find a CSV in `directory` matching `base_prefix`, where base_prefix
#     is the part of the filename BEFORE the first "LensData".
#     Will try several flexible glob patterns to match files that have extra suffixes
#     after "LensData", e.g. *_LensData_21.6_5.6_60.csv or *_LensData-v2.csv.
#     Returns path or None.
#     """
#     if not os.path.isdir(directory):
#         return None

#     # flexible patterns: prefer more exact (LensData present) then fall back
#     patterns = [
#         os.path.join(directory, base_prefix + "*LensData*.*"),
#         os.path.join(directory, "*" + base_prefix + "*LensData*.*"),
#         os.path.join(directory, base_prefix + "*.*"),
#         os.path.join(directory, "*" + base_prefix + "*.*"),
#     ]
...
# # ---------------------------
# # Build list of lens base names AND actual filenames
# # ---------------------------
...
# bases = []            # "CH321571_Example01P"
# actual_filenames = [] # "CH321571_Example01P_LensData_21.6_5.6_60"

# for path in materials_files:
#     fname = os.path.basename(path)
#     name_no_ext = os.path.splitext(fname)[0]

#     # Split at first occurrence of "LensData"
#     parts = name_no_ext.split("LensData", 1)
#     base = parts[0].rstrip("_")          # everything before LensData
#     actual = name_no_ext                 # entire real filename

#     bases.append(base)
#     actual_filenames.append(actual)

# # Deduplicate bases and maintain mapping
# seen = set()
# bases_unique = []
# actual_map = {}

# for base, actual in zip(bases, actual_filenames):
#     if base not in seen:
#         seen.add(base)
#         bases_unique.append(base)
#         actual_map[base] = actual
...
#     row = {"File Name": actual_map[base]}

#     # --- Materials ---
#     # (note: MATERIALS_COLS is empty by your preference; code kept for completeness)
